            ...
            <div id="content">
               ...
               .loader {
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Centralized Directory</h1>
                    <p class="mb-4">Manage color of your website
                    </p>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Centralized</h6>
                        </div>
